...
//  Thursday
//
//  Created by Scott Begin on 1/16/23.
//
...
//    @State var player = AVPlayer(url: URL(string: "https://thursday-content.s3.amazonaws.com/Explainer01.mp4")!)
...
//                }
                ...
                Button(action: {
                    ...
                    Image(systemName: self.isplaying ? "" : "play.fill")
                        .font(.title)
                        .foregroundColor(.white)
                        .padding(20)
                }
